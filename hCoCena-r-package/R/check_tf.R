...
#' 
#' This function leverages the information collected with TF_enrich_all()
...
check_tf <- function(TF){
	...
	#plot to PDF:
	Cairo::CairoPDF(file = base::paste0(hcobject[["working_directory"]][["dir_output"]], hcobject[["global_settings"]][["save_folder"]], "/", TF, "_starplot.pdf"), width = 10,
	                            height = 10)
