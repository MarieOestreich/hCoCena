#' KEGG Profiling
#' 
#' Returns a cluster-wise KEGG Database enrichment.
...
kegg_profiling <- function(top, padj = "BH", clusters = c("all"), qval = 0.05){
  ...
  openxlsx::write.xlsx(x = res, file = base::paste0(hcobject[["working_directory"]][["dir_output"]], hcobject[["global_settings"]][["save_folder"]], "/kegg_enrichment.xlsx"), overwrite = T)
