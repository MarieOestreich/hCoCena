...
# @Kilian: Currently, the network plot is also overprinted by the result of visualize_gene_expression. Hopefully the problem resolves once the visualize_gene_expression function works properly (below)
...
# @Kilian: Currently plotted on top of each other/not plotted
