...
## Working directory setup
  ...
  Please set the following parameters to strings that state the path to your data, etc. For more information on the different files and how to pass them to the 
  function, please refer to the following section of the wiki: https://github.com/MarieOestreich/hCoCena/wiki/General-Backgroud-Information#count-files-annotation-files--reference-files
...
init_wd(dir_count_data = FALSE,
        ...
        dir_reference_files = "D:/PhD_backups/PhD/hCoCena/test_case/reference_files/", #the folder that contains the reference files
