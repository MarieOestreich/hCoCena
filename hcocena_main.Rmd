...
## Working directory setup
  ...
  Please set the following parameters to strings that state the path to your data, annotations, etc.:
...
## Database enrichment
  ...
  The outputs all have a slot called "enrichment", that contains the clusterProfiler enrich-object for each cluster. This can be used as input for further clusterProfiler visualisations. Please refer to the clusterProfiler documentation.
