...
```{r meta data plots}
# For the array data
meta_plot(set = 1, group_col = "merged", meta_col = "stimuli", type = "cat", 
          cols = c("IL4" = "#00A1D5FF", "IFNg" = "#79AF97FF", "baseline" = "#374E55FF"))
meta_plot(set = 1, group_col = "merged", meta_col = "Donor", type = "cat", 
          cols = c("BC9" = "#FBB4AE", "BC11" = "#B3CDE3", "BC13" = "#CCEBC5", "BC78" = "#DECBE4"))

# For the RNA-seq data
meta_plot(set = 2, group_col = "merged", meta_col = "Phenotype", type = "cat", 
          cols = c("IL4" = "#00A1D5FF", "IFNg" = "#79AF97FF", "baseline" = "#374E55FF"))
meta_plot(set = 2, group_col = "merged", meta_col = "Donor", type = "cat", 
          cols = c("BC9" = "#FBB4AE", "BC11" = "#B3CDE3", "BC13" = "#CCEBC5", "BC78" = "#DECBE4"))
